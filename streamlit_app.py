...
# 2. ตั้งค่าการดึงข้อมูลจากไฟล์ 'การตอบแบบฟอร์ม 1'
...
try:
    ...
    def plot_lj(data, col_name, title):
        ...
        # คำนวณค่า Mean/SD จากข้อมูลในตาราง
